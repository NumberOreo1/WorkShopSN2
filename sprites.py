...
dialogues_Emma_salon = DialogBox('Sarah', ["Salut, utilisateur Sarah.", "Je m'appelle Emma, et je serais ton guide. ", "Ton objectif sera de trouver dans mon ordinateur une donnée sensible.", "Pour cela, tu vas devoir rentrer dans mon ordinateur.", "Ne t'inquiète pas, je serais là pour te guider.", "Bon courage."])
dialogues_Emma_teleporter = DialogBox('Sarah', ["Bienvenue !", "Tu te situe dans mon ordinateur", "Maintenant, tu vas te diriger vers la porte en bas...", "Ce sera l'entrée vers le firewall", "Je t'expliquerai à l'intérieur ta mission"])
...
camera_groups = {
    ...
    "Server": CameraGroup(name_map='Server', list_teleporters=[('ExitServer', 'FirewallOuvert', 'ExitServer')], layers_obstacles=(['Collisions'], server_collisions), messages=dialogues_Emma_server, name_interaction="BDD")
}
# Water Fall ;)
