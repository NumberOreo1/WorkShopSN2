...
#Messages
dialogues_caporal_intro = DialogBox('Caporal', ["Blabla", "Blabla", "Blabla"])
dialogues_Emma_salon = DialogBox('Emma', ["Salut, utilisateur Sarah.", "Je m'appelle Emma, et je serais ton guide. ", "Ton objectif sera de trouver dans mon ordinateur une donnée sensible.", "Pour cela, tu vas devoir rentrer dans mon ordinateur.", "Ne t'inquiète pas, je serais là pour te guider.", "Bon courage."])
...
camera_groups = {
    ...
    "Teleporter": CameraGroup(name_map='Teleporter', list_teleporters=[('ExitTeleporter', 'Salon', 'ExitTeleporter'), ('EntranceFirewall', 'Firewall', 'EntranceFirewall')], layers_obstacles=(['Collisions'], teleporter_collisions), messages=dialogues_Emma_teleporter, name_interaction="AucuneInteraction"),
    "Firewall": CameraGroup(name_map='Firewall', list_teleporters=[('ExitFirewall', 'Teleporter', 'ExitFirewall'), ('EntranceServer', 'Server', 'EntranceServer')], layers_obstacles=(['Collisions'], firewall_collisions), messages=dialogues_Emma_firewall, name_interaction="Terminal"),
    "Server": CameraGroup(name_map='Server', list_teleporters=[('ExitServer', 'Firewall', 'ExitServer')], layers_obstacles=(['Collisions'], server_collisions), messages=dialogues_Emma_server, name_interaction="AucuneInteraction")
}
# Water Fall ;)
