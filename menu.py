...
class Menu:
  ...
  def run(self):
    if self.class_joueur is None:
      ...
      bouton_archer = pygame.Rect(
        (self.screen.get_width() - largeur_bouton) / 2, 700, largeur_bouton,
        50)
      bouton_start = pygame.Rect(
        (self.screen.get_width() - largeur_bouton) / 2, 300, largeur_bouton,
        50)
      ...
      while True:
        for event in pygame.event.get():
          ...
          if event.type == pygame.KEYDOWN:
            ...
            if bouton_start.collidepoint(pygame.mouse.get_pos()):
              player = Archer("Sarah",
                              camera_group.carte.get_waypoint('Spawn'),
        ...
        texte_bienvenue = font_grand.render(
          "Bienvenue dans le meilleur workshop de France", True,
          (255, 255, 255))
        self.screen.blit(
          texte_bienvenue,
          ((self.screen.get_width() - texte_bienvenue.get_width()) / 2, 50))
        ...
        pygame.draw.rect(self.screen, (255, 255, 255), bouton_start)
        ...
        pygame.draw.rect(self.screen, (0, 0, 0), bouton_start, 3)
        ...
        texte_start = font.render("Commencer", True, (0, 0, 0))
        ...
        self.screen.blit(texte_start,
                         (bouton_start.x + 10, bouton_start.y + 10))
